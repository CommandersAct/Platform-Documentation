...
| `email_md5`    | `string` | No       | 8eb1b52... (size 32) | Email, hashed using [MD5 algorithm](https://en.wikipedia.org/wiki/MD5)                                                                                            |
| `email_sha256` | `string` | No       | 836f82d... (size 64) | Email, hashed using [SHA-256 algorithm](https://en.wikipedia.org/wiki/SHA-2)                                                                                      |
