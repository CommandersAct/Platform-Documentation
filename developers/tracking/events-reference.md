...
| `email`        | `string` | Yes\*     | john.doe@example.com | <p>Email (plain value)</p><p>(*) required for many destinations and internal processing.</p> Not required if `email_sha256` is provided                         |
