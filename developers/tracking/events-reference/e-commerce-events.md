...
| `items`          | [`Array<Item>`](e-commerce-events.md#item)  | No       |                                                                                                                                                               | The items for the event.                                                                                                                                                                                                                                                                           |
...
| `items`         | [`Array<Item>`](e-commerce-events.md#item)  | **Yes**  |                                                                                                                                                               | The items for the event.                                                                                                                                                                                                                                                                  |
...
| `items`           | [`Array<Item>`](e-commerce-events.md#item)  | **Yes**  |                                                                                                                                                               | The items for the event.                                                                                                                                                                                                                                         |
| `payment_method`  | `string`                                    | **Yes**  | card                                                                                                                                                          | Payment method type (see list of [possible values](e-commerce-events.md#payment-methods) below)                                                                                                                                                                  |
| `status`          | `string`                                    | **Yes**  | in\_progress                                                                                                                                                  | <p>Status of the conversion (see list of <a href="e-commerce-events.md#purchase-status">possible values</a> below).<br><em>Conversions with status "pending" are not included in default sum and counts aggregated on augmented user attributes feature</em></p> |
| `last_channel`    | `string`                                    | No       | display                                                                                                                                                       | The last channel just before the purchase.                                                                                                                                                                                                                       |
| `last_source`     | `string`                                    | No       | google.com                                                                                                                                                    | The last source (referrer) just before the purchase.                                                                                                                                                                                                             |
...
| `coupon`          | `string`                                    | No       | CHRISTMAS                                                                                                                                                     | Coupon code used for a purchase.                                                                                                                                                                   |
| `type`            | `string`                                    | **Yes**  | offline                                                                                                                                                       | Type of conversion (online, offline, call etc.)                                                                                                                                                    |
| `items`           | [`Array<Item>`](e-commerce-events.md#item)  | No\*     |                                                                                                                                                               | (\*) `items` is required for partial refunds but it can be omitted for full refunds.                                                                                                               |
...
| `items`          | [`Array<Item>`](e-commerce-events.md#item) | **Yes**  |                  | The items for the event. The `items` array is expected to have a single element, representing the selected item. |
