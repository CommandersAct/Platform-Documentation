...
| `items`          | [`Array<Item>`](./#item)  | No       |                                                                                                                                                               | The items for the event.                                                                                                                                                                                                                                                                           |
...
| `items`         | [`Array<Item>`](./#item)  | **Yes**  |                                                                                                                                                               | The items for the event.                                                                                                                                                                                                                                                                  |
...
| `tax_amount`      | `number`                  | No       | 3.20                                                                                                                                                          | Tax associated with a transaction.                                                                                                                                                                                                             |
...
| `items`           | [`Array<Item>`](./#item)  | **Yes**  |                                                                                                                                                               | The items for the event.                                                                                                                                                                                                                       |
| `payment_method`  | `string`                  | **Yes**  | card                                                                                                                                                          | Payment method type (see list of [possible values](./#payment-methods) below)                                                                                                                                                                  |
| `status`          | `string`                  | **Yes**  | in\_progress                                                                                                                                                  | <p>Status of the conversion (see list of <a href="./#purchase-status">possible values</a> below).<br><em>Conversions with status "pending" are not included in default sum and counts aggregated on augmented user attributes feature</em></p> |
...
| `coupon`          | `string`                  | No       | CHRISTMAS                                                                                                                                                     | Coupon code used for a purchase.                                                                                                                                                                   |
| `type`            | `string`                  | **Yes**  | offline                                                                                                                                                       | Type of conversion (online, offline, call etc.)                                                                                                                                                    |
| `items`           | [`Array<Item>`](./#item)  | No\*     |                                                                                                                                                               | (\*) `items` is required for partial refunds but it can be omitted for full refunds.                                                                                                               |
...
| `items`          | [`Array<Item>`](./#item) | **Yes**  |                  | The items for the event. The `items` array is expected to have a single element, representing the selected item. |
...
| `price`      | `number`            | **Yes**   | 14.99          | The price of the product (taxes and discount **excluded)**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `consent_categories` | `Array`  | **Yes**  | \[1,3,4]             | <p>User's consent categories. It should contain only the categories where the user has given his consent.<br>Necessary to grant data sharing with destination partners. It is automatically filled from web sources if you use Commanders Act CMP.</p> |
