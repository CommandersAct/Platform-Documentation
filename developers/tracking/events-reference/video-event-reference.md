...
| `interruption_method` | `String`                                                      | No       | <p>For the <code>Video Playback Interrupted</code> events,<br>you can send this property denoting how the</p><p>playback was interrupted.</p><p>Some examples include 'device_lock', 'call', and</p><p>'browser_redirect'.</p>                                                                                                                                                     |
