...
* Refinement of the tc\_do\_not\_track flag handling in CMP and server-side hits
...
* Added tc\_do\_not\_track parameter to specific CMP and server-side hits for improved alignment with consent settings
...
* \[beta] Remove cookie MIX\_CLICK after first OneTag send
...
* Infer value of page\_type from env\_template in page\_view events
...
* Upgrade of the container and privacy banner generation engine.
  ...
  * As usual, please report to [support@commanderact.com](mailto:support@commanderact.com) issues that you would encounter with this generator version.
...
* Add tc\_privacy\_do\_not\_track flag
...
* Add refused\_vendors in CAX events
...
* Tag Deduplication - Add a (programatic) option to not use tc\_cj\_v2 encryption. This is a requirement for WAF restrictions of some TagCommander users.
...
* Fix TC\_PRIVACY cookie content caused by a retro-compatibility issue with old banners
...
* Fix tc\_array\_events object initialization
