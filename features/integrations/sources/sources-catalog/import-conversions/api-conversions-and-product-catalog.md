...
| body          | body   | [Conversion](broken-reference) | true     | Conversions as newline delimited JSON strings |
...
| ------------- | ------ | --------------------------- | -------- | ------------------------------------------ |
| Authorization | header | string                      | true     | Authorization token                        |
| body          | body   | [Product](broken-reference) | true     | Products as newline delimited JSON strings |
...
| billing\_address          | [Address](broken-reference)           | false    | none         | It is recommended to use as many fields as you can in order to be able to build good segments with advanced conditions                                                                                                                             |
| contact\_address          | [Address](broken-reference)           | false    | none         | It is recommended to use as many fields as you can in order to be able to build good segments with advanced conditions                                                                                                                             |
| shipping\_address         | [Address](broken-reference)           | false    | none         | It is recommended to use as many fields as you can in order to be able to build good segments with advanced conditions                                                                                                                             |
...
| conversion\_items         | \[[ConversionItem](broken-reference)] | true     | none         | List of products in the conversion + their own attributes. You cannot have the same product twice inside a conversion unless you provide a conversion item id                                                                                      |
