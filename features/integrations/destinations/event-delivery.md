...
* **Delivered:** This displays the number of messages successfully delivered to a destination within the time period you choose.\
  ...
  * <img src="../../../.gitbook/assets/image (33).png" alt="" data-size="line">sunny if the % of events successfully delivered is above 95%
  * <img src="../../../.gitbook/assets/image (44).png" alt="" data-size="line">cloudy between 90 and 95%
  * <img src="../../../.gitbook/assets/image (13).png" alt="" data-size="line">rainy between 50 and 90%
  * <img src="../../../.gitbook/assets/image (50).png" alt="" data-size="line">stormy below 50%
*   **Not Delivered:** This number represents the number of messages that the platform was unable to deliver. If this number is more than zero, the causes for this failure are listed in the errors' table below.
    ...
    * <img src="../../../.gitbook/assets/image (33).png" alt="" data-size="line">sunny if the % of failures is below 5%
    * <img src="../../../.gitbook/assets/image (44).png" alt="" data-size="line">cloudy if the % of failures is below 10%
    * <img src="../../../.gitbook/assets/image (13).png" alt="" data-size="line">rainy if the % of failures is between 10% and 50%
    * <img src="../../../.gitbook/assets/image (50).png" alt="" data-size="line">stormy if the % of failures is above 50%
