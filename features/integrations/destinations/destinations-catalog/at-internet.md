...
3. Search for "**AT Internet**" and click it.
4. Click **Configure** (top-right).
5. In **Data Source**, **** select your **Sources** and **Events** that will send data to AT Internet and click **Next**.
6. In **Settings**, input a **Destination name** and select an **Environment**.
7. Input your **Site Id** and **Secured Collection Domain**.
8. You can flag **Advanced Settings** and select the **User Identifier** you need to bridge.
...
| Commanders Act Properties | AT Internet Field |
| ------------------------- | ----------------- |
