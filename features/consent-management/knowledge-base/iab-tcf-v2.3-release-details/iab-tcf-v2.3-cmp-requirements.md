...
If you don't have yet an accept all / refuse all buttons in your privacy center, you must add them manually. You can refer to the step n°2 of [this page](../iab-tcf-v2.2-release-details/iab-tcf-v2.2-migration-guide-web.md) for setup help
