...
The data quality indicator allows to quickly visualize the status of the source, if data are of good quality (<img src="../../.gitbook/assets/image (17) (1).png" alt="" data-size="line">) or not (<img src="../../.gitbook/assets/image (14) (2).png" alt="" data-size="line">) on the last hour.
