...
&#x20;**\[2]** Set when `Conversion Type` is `Lead` .\
&#x20;**\[3]** Value is set based on the priority in the left column.\
&#x20;**\[4]** Value hashed using`SHA-256` .\
&#x20;**\[5]** Either <mark style="color:blue;">`1`</mark> or <mark style="color:blue;">`0`</mark> , depending if `user.id` is a valid email or an non-email identifier respectively.\
&#x20;**\[6]** All products are taken into account.
{% endhint %}
