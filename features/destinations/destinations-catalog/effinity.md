...
| `Id Compteur`             | <p><em><code>Required</code></em> <em><strong>if not provided through alternative methods: see</strong></em> <a href="effinity.md#destination-setup"><em><strong>Destination setup</strong></em></a><em><strong>.</strong></em><br>The only information necessary for attribution as it's used to identify the ad.</p>                                                                  |
