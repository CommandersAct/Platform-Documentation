...
Using this destination, you can leverage [Tiktok Sync Order Information endpoint](https://app.gitbook.com/u/TyQmmynWMvMlk9NdUinevOT5XTl2) to update the status of your orders.

## Key features

The TikTok Sync Order Information destination provides the following key features:

* **Events structure**: our [Events reference](https://community.commandersact.com/platform-x/developers/tracking/events-reference) supports [TikTok order statuses](https://app.gitbook.com/u/TyQmmynWMvMlk9NdUinevOT5XTl2), meaning that your data is properly bridged to the expected fields in an optimized way.
...
&#xNAN;**\[3] Set in** <mark style="color:blue;">`spu_list.0.sku_list.0`</mark> .\
&#xNAN;**\[4]** Mandatory property for order status <mark style="color:blue;">`COMPLETE_ORDER`</mark> .\
&#xNAN;**\[5]** Set in <mark style="color:blue;">`value.commission_value.0`</mark> .\
