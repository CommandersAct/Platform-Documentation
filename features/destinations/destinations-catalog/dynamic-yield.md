...
&#xNAN;**\[2]** This property is set in <mark style="color:blue;">`events[0].properties`</mark>.\
&#xNAN;**\[3]** See [Quick reference](dynamic-yield.md#quick-reference) for more details.\
