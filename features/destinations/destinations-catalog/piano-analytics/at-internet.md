...
{% hint style="info" %}
**\[\*]** Custom events must be added to the Piano Analytics' data model first or they won't be processed. You can add new events by following ![](../../../../.gitbook/assets/piano\_1.png) ➜ `SETTINGS` ➜ `Data Management` ➜ `Data Model` ➜`Events`.\
