...
* **Property mapping**: send all properties in your event or select the ones to include. See `Send All Properties` and `Custom Event Properties` in [Configuration](azure-event-hub.md#configuration).
