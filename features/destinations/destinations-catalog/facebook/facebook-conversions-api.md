...
> &#xNAN;**\[7]** The identifier issued by Meta when a person first logs into an instance of an app. This is also known as App-Scoped ID.\
> &#xNAN;**\[8]** In <mark style="color:blue;">`integrations.facebook`</mark> of your event.
{% endhint %}
